...
> **TODO — Mission population:** Define the utilization escape, Instructor Encounter, evidence placement, voiceprint controls, exterior destination, rewards, and supporting dialogue in a later population pass.
...
flowchart LR
    ...
    Exterior --> TODO[Destination TODO]
```

Entering either physical exit commits the campaign to that route. Successful extraction may instead return to [[Missions/HUB2|HUB2]] before committing; failure returns there.
